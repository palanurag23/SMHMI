...
int gfx_drawPoint(gfx_surface_t *pOverlay, int points_x, int points_y, int radius, int color)
{
    ...
    if (gGfxDev != NULL && gGfxDev->ops->drawPoint != NULL)
    {
        ret = gGfxDev->ops->drawPoint(gGfxDev, pOverlay, points_x, points_y, radius, color);
    }
...
int gfx_drawLine(gfx_surface_t *pOverlay, int left_x, int top_y, int right_x, int bottom_y, int line_width, int color)
{
    ...
    if (gGfxDev != NULL && gGfxDev->ops->drawLine != NULL)
    {
        ret = gGfxDev->ops->drawLine(gGfxDev, pOverlay, left_x, top_y, right_x, bottom_y, line_width, color);
    }
