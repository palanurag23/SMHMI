 ...
 * Definitions
 ******************************************************************************/
#define FLEXIO_DMA_BASE     DMA0
#define FLEXIO_DMAMUX_BASE  DMAMUX0
/*******************************************************************************
 * Variables
 ******************************************************************************/
                                   ...
                                   flexio_camera_dma_t *dmaConfig)
{
    ...
    /* Configure DMA MUX Source */
    DMAMUX_SetSource(FLEXIO_DMAMUX_BASE, dmaCh, dmaRequestSource);

    /* Enable DMA channel. */
    DMAMUX_EnableChannel(FLEXIO_DMAMUX_BASE, dmaCh);
}
#endif
