...
#define BOARD_SEM4_I2C5_GATE 2
#define BOARD_SEM4_I2C6_GATE 3
#define BOARD_SEM4_SHAREDB_GATE 4
...
void BOARD_FlexioCameraConfigDMA(void);
void BOARD_ShareDb_Unlock(void);
void BOARD_ShareDb_Lock(void);
#if defined(__cplusplus)
}
#endif /* __cplusplus */
