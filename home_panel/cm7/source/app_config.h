...
#define APP_PROMPTS_SIZE   0x00132a80
#define APP_MODELS_SIZE    0x002b9540

#if ((APP_PROMPTS_SIZE + APP_ICONS_SIZE + APP_LVGL_IMGS_SIZE + APP_MODELS_SIZE) > FICA_IMG_RESOURCE_SIZE)
#error "Resource true size exceeds reserved size"
#endif /* ((APP_PROMPTS_SIZE + APP_ICONS_SIZE + APP_LVGL_IMGS_SIZE) > FICA_IMG_RESOURCE_SIZE) */
