...
#define FICA_IMG_APP_SIZE      (0x00500000)      /* 5 MB */
#define FICA_IMG_APP_A_SIZE    FICA_IMG_APP_SIZE /* 5 MB */
#define FICA_IMG_APP_B_SIZE    FICA_IMG_APP_SIZE /* 5 MB */
...
#define FICA_IMG_FILE_SYS_ADDR   (FICA_IMG_BANK_B_ADDR + FICA_IMG_BANK_SIZE)
